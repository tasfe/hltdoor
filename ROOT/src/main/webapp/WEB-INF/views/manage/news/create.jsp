            ...
            <div class="col-md-9">
                <div class="main-box">
                    ...
                    <div class="main-box-content">
                        <form action="<%=request.getContextPath()%>/manage/gallery/" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>名称</label>
                                        <input type="text" class="form-control" name="hTitle">
                                        <p class="help-block">文章名称</p>
                                    </div>
                                    <div class="form-group">
                                        <label>风格</label>
                                    ...
                                    <div class="form-group">
                                        <label>3D全景地址</label>
                                        <input type="text" name="hVr" class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>楼盘</label>
                                        <input type="text" name="hBuilding" class="form-control">
                                        <p class="help-block">楼盘名称</p>
                                    </div>
                                    <div class="form-group">
                                        <label>户型</label>
                                        <input type="text"name="hHouseType" class="form-control">
                                        <p class="help-block">户型 例如:三房两厅</p>
                                    </div>
                                    <div class="form-group">
                                        <label>面积</label>
                                        <input type="text" name="hHouseSize" class="form-control">
                                        <p class="help-block">住房面积 例如: 128</p>
                                    </div>
                                    <div class="form-group">
                                        <label>风格</label>
                                        <input type="text" name="hHouseStyle" class="form-control">
