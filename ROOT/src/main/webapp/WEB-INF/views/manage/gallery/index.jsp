                    ...
                    <div class="main-box-content">
                        <table class="table table-bordered table-data table-responsive">
                            ...
                            <c:forEach items="${pageInfo.list}" var="gallery">
                                <tr id="data-${gallery.id}">
                                    <td>${gallery.hTitle}</td>
                                    <td class="text-center"><a
                                            href="<%=request.getContextPath()%>/manage/gallery/${gallery.id}/edit">
                                        <i class="fa fa-edit"></i>&nbsp;编辑
                                    </a>
                                    </td>
                                    <td class="text-center">
                                        <a href="#" class="delete" data-id="${gallery.id}">
    ...
    $(function () {
        $(".delete").click(function () {
            ...
            if (confirm("删除后不可恢复,确定删除此案例吗?")) {
                $.ajax({
                    url: "<%=request.getContextPath()%>/manage/gallery/" + id,
                    type:"delete",
                    dataType:"text",
